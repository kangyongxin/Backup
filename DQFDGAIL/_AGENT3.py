...
class AGENT3:
    ...
    def save_model(self):
        # print("AGENT Model saved in : {}".format(self.saver.save(self.Agentsess, self.config.AGENT_MODEL_PATH)))
        print("AGENT Model saved in : {}".format(self.saver.save(self.sess, self.config.AGENT_MODEL_PATH)))

    def restore_model(self):
        # self.saver.restore(self.Agentsess, self.config.AGENT_MODEL_PATH)
        self.saver.restore(self.sess, self.config.AGENT_MODEL_PATH)
        print("AGENT Model restored.")
