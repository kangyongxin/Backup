...
class Maze(tk.Tk, object):
    ...
    def step(self, action):
        ...
        if s_ == self.canvas.coords(self.oval):
            ...
            s_ = 'terminal'
        elif s_ in [self.canvas.coords(self.hell1), self.canvas.coords(self.hell2),self.canvas.coords(self.hell3),self.canvas.coords(self.hell4),self.canvas.coords(self.hell5), self.canvas.coords(self.hell6)]:
            reward = 0
            done = True
            s_ = s
            # done = False
