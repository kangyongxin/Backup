...
class Config:
    ...
    AGENT_MODEL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'model/agent_model_CartPole_03282')
    ...
    #configures for GAIL
    SOUL_MODEL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'model/soul_model_CartPole_03282')
