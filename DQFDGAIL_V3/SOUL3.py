...
class SOUL3:
    ...
    def save_model(self):
        print("soul Model saved in : {}".format(self.saver.save(self.Soulsess, self.config.SOUL_MODEL_PATH)))

    def restore_model(self):
        self.saver.restore(self.Soulsess, self.config.SOUL_MODEL_PATH)
